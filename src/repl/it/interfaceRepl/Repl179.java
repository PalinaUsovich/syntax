...
public class Repl179 implements Functions{
    ...
    @Override
    public double subtracting(double firstNum, double secondNum) {
        return  firstNum - secondNum;
    }
    ...
    @Override
    public double dividing(double firstNum, double secondNum) {
        return  firstNum / secondNum;
    }
    ...
    public static void main(String[] args) {
        ...
        Repl179 repl = new Repl179();
        repl.display(repl.adding(firstNumber,secondNumber));
        repl.display(repl.subtracting(firstNumber,secondNumber));
        repl.display(repl.multiply(firstNumber, secondNumber));
        repl.display(repl.dividing(firstNumber, secondNumber));
     ...
     * First Methods: return type void, method name display,
     * parameters -> result (choose the datatype as required)
     *
     ...
     * Adding, Subtracting, Multiply, dividing each will have the logics
     * to do simple mathematic operation and return the result.
     *
     * Step 9: Create the main method inside the main method declare below variables.
     * double firstNumber = 100.00;
     * double secondNumber = 20.00;
     *
     * Step 10: Instantiate the object of Main class and call the methods
     * one by one to print the result and sequence of shown below in output.
     *
     * Expected Output:
     * Result is ::: 120.0
     * Result is ::: 80.0
