...
public class Repl154 {
     ...
     * Now it's "loop through all the elements of the 2-D array" instead of "loop
     * through all the elements of the 1-D array".  You know how to loop through a 2-D array.
     * You got this.
     *
     * In Main Class:
     * Create relation between Main class and Method by making Main class as a
     * subclass of the Method Class
     * Use Array:
     * int[][] a = {
     *                  { 1, 2, 3 },
     *                  { 4, 5, 6 },
