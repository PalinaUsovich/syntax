...
public class Repl147 {
    ...
    Repl147(String label,  double price,  String category, boolean hasExpiration,  int stock){
        this.label = label;
        this.price = price;
    ...
    Repl147(String label,  double price,int stock){
        this.label = label;
        this.price = price;
        this.stock = stock;
        this.category = "misc";
    ...
    Repl147(String label,  double price){
        this.label = label;
        this.price = price;
        this.stock = 0;
    ...
    public static void main(String[] args) {
        Repl147 repl1 = new Repl147("Eggs", 10.0, "Produce", true, 10);
        repl1.display();
        Repl147 repl2 = new Repl147("Milk",2.0,7);
        repl2.display();
        Repl147 repl3 = new Repl147("Milk", 2.0);
        repl3.display();
     ...
     *
     * * Second constructor with all parameters except category and hasExpiration (category defaults
     * to "misc",
     * hasExpiration defaults to false inside constructor)
     *
     * * Third constructor all the parameters except category,
